...
app.post('/games', async(req, res) => {
  try {
    ...
    const data = await client.query(`
      INSERT INTO games(name, platform_id, genre, mature, price, rating, image)
      VALUES($1, $2, $3, $4, $5, $6, $7)
      RETURNING * 
      `, [newGame.name, newGame.platform_id, newGame.genre, newGame.mature, newGame.price, newGame.rating, newGame.image]);
